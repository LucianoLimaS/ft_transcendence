...
class Match(models.Model):
    ...
    player_1 = models.ForeignKey(Users, on_delete=models.CASCADE, related_name='matches_as_player1')
    player_2 = models.ForeignKey(Users, on_delete=models.CASCADE, related_name='matches_as_player2')
